...
public class TestScreenButton extends Button {
	...
	final ResourceLocation information_tabletgui = new ResourceLocation(Test.MOD_ID, "textures/gui/book1right.png");
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		if(visible) {
			Minecraft.getInstance().getTextureManager().bindTexture(information_tabletgui);
