...
public class Old_RenderCauldronBlock extends TileEntityRenderer<TileCauldronBlock> {
	...
	public Old_RenderCauldronBlock(TileEntityRendererDispatcher rendererDispatcherIn) {
	...
	@Override
	public void render(TileCauldronBlock tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
        ...
        if(scale == 0.330f) { matrixStackIn.translate(0, -.2, 0); matrixStackIn.scale(.6f, scale + 0.110f, .6f);  } else if(scale == 0.440f) { matrixStackIn.translate(0, -.3, 0); matrixStackIn.scale(.6f, scale + 0.110f, .6f); } else if(scale == 0.550f) { matrixStackIn.translate(0, -.5, 0); matrixStackIn.scale(.6f, scale + 0.210f, .6f); } else { matrixStackIn.scale(.6f, scale, .6f); }
        matrixStackIn.translate(-.5, scale, -.5);
        
        // Top Face
        add(builder, matrixStackIn, 1 - .9f, 1, .9f, sprite.getMinU(), sprite.getMaxV(), r, g, b, a);
        add(builder, matrixStackIn, 0 + .9f, 1, .9f, sprite.getMaxU(), sprite.getMaxV(), r, g, b, a);
        add(builder, matrixStackIn, 0 + .9f, 1, .1f, sprite.getMaxU(), sprite.getMinV(), r, g, b, a);
        add(builder, matrixStackIn, 1 - .9f, 1, .1f, sprite.getMinU(), sprite.getMinV(), r, g, b, a);
		matrixStackIn.pop();
	}
