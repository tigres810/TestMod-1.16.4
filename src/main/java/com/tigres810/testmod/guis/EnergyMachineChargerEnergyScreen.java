...
public class EnergyMachineChargerEnergyScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.font.drawString(matrixStack, "Energy: " + energy, ((width / 2) - this.font.getStringWidth("test") / 2), relY + 10, 0x000000);
    ...
    public static void open(int ENERGY) {
    	energy = ENERGY;
        Minecraft.getInstance().displayGuiScreen(new EnergyMachineChargerEnergyScreen());
    }
