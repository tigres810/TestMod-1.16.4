...
public class TestScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if(currentpage == 0) {
        	...
        	this.font.drawString(matrixStack, I18n.format("gui.leftpage0.1"), ((width / 2) - this.font.getStringWidth("Prueba") / 2) - 60, relY + 21, 0x000000);
        	this.font.drawString(matrixStack, I18n.format("gui.leftpage0.2"), ((width / 2) - this.font.getStringWidth("Prueba") / 2) - 60, relY + 30, 0x000000);
        	this.font.drawString(matrixStack, I18n.format("gui.leftpage0.3"), ((width / 2) - this.font.getStringWidth("Prueba") / 2) - 60, relY + 39, 0x000000);
        }
